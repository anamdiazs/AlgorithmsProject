namespace ProyectoFinal
{
    partial class Form12
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label3.Text = "Medida de lado 2:";
			// 
			// textBox2
			// 
			...
			this.pictureBox1.Location = new System.Drawing.Point(114, 143);
			...
			this.label1.Text = "Medida de lado 1:";
			// 
			// button4
			// 
			this.button4.BackColor = System.Drawing.Color.Red;
			this.button4.Location = new System.Drawing.Point(269, 346);
			...
			this.button2.Location = new System.Drawing.Point(347, 346);
			...
			this.label2.Text = "Ingresa los datos solicitados";
			// 
			// label4
			// 
			...
			this.label4.Text = "Medida la altura:";
			// 
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(309, 68);
			...
			this.label5.Text = "Medida la base:";
			// 
			// textBox4
			// 
